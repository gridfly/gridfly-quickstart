...
This project contains a simple example of how to call the GridFlyApi from Java.

It will generate an API client from the GridFly API specification

It uses canned JSON as the datasource and Velocity as the templating library, however any datasource and templating
library can be used.
